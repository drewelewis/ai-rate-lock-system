...
async def test_servicebus_config():
    ...
    print("\n📋 Topic Configuration:")
    print(f"  - Agent Workflow: {azure_config.get_servicebus_topic_agent_workflow()}")
    print(f"  - Audit Events: {azure_config.get_servicebus_topic_audit_events()}")
    print(f"  - Audit Logging: {azure_config.get_servicebus_topic_audit_logging()}")
    print(f"  - Exception Alerts: {azure_config.get_servicebus_topic_exception_alerts()}")
    print(f"  - Workflow Events: {azure_config.get_servicebus_topic_workflow_events()}")
